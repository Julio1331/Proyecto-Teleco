...
function drawChart() {
    var data = google.visualization.arrayToDataTable([
        ['Promedio de CO2', 'Días por Intervalo'],
        ['0°C a 10°C', 11],
        ['10°C a 15°C', 8],
        ['15°C a 20°C', 9],
        ['20°C a 25°C', 7],
    ...
    var chart = new google.visualization.PieChart(document.getElementById('co2'));
...
function drawChart1() {
    var data = google.visualization.arrayToDataTable([
        ['Promedio de Gas', 'Días por Intervalo'],
        ['0% a 10°%', 11],
        ['10% a 20%', 8],
        ['20% a 30%', 9],
        ['30% a 40%', 7],
    ...
    var options = {
        title: 'Distribución de Gas',
        is3D: true,
    };
    var chart = new google.visualization.PieChart(document.getElementById('gas'));
    chart.draw(data, options);
}
